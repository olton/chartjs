...
(function () {
    ...
    class BarChart extends Chart {
      ...
      barsX() {
        ...
        if (this.proxy.mouse) {
          this.proxy.mouse.x - rect.left;
          this.proxy.mouse.y - rect.top;
        }
        ...
        for (var graph of this.data) {
          ...
          var name = graph.name;
          var data = graph.data;
          colors.length > 1 ? o.color : colors[0];
          var groupWidth = 0;
    ...
    class PieChart extends Chart {
      ...
      sectors() {
        ...
        for (var _sector of this.data) {
          ...
          textVal = o.showValue ? _sector.data : val + "%";

          if (typeof o.onDrawValue === 'function') {
            textVal = o.onDrawValue.apply(null, [_sector.data, val, textVal]);
          }
